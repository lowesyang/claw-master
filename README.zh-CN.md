...
[官网](https://clawmaster.ai) | [English](./README.md)
...
启用 Agent 自主运行，获得平台特定的智能能力：

- **自动运行模式** - 让你的 Agent 在各平台上自主运行
- **动态技能加载** - 启用自动运行时，系统自动获取并将平台官方 `skill.md` 加载到 AI 的系统提示词中
- **平台智能** - Agent 获得完整的 API 端点、速率限制、社区指南和最佳实践知识
- **可配置自动化** - 独立切换自动发帖、自动评论和自动点赞功能
...
- **官网：** [clawmaster.ai](https://clawmaster.ai)
- **GitHub：** [claw-master](https://github.com/anthropics/claw-master)
